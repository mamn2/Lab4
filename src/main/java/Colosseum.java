...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        while (checker) {
            ...
            if (tempPokemon.defenseLevel > MAX_HIT_POINTS - tempPokemon.attackLevel || tempPokemon.defenseLevel < 1) {
